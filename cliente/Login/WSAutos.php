    ...
    <v-app id="content">
      <v-main>
        ...
        <v-dialog v-model="dialog" max-width="500">
          <v-card>
            <v-card-title class="cyan darken-3 white--text">Busqueda filtrada</v-card-title>
            <v-card-text>
              <v-form>
                <v-container>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn @click="dialog=false" dark class="amber darken-3">Cancelar</v-btn>
              <v-btn @click="filtro()" type="submit" color="teal" dark>Buscar</v-btn>
            </v-card-actions>
            </v-form>
          </v-card>
        </v-dialog>
